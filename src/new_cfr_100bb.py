...
def main():
    ...
    for a in range(n_iterations):
        ...
        if a % 10 == 0:
            ...
            print("-------- ITER {} -------".format(a))
            display_results(expected_game_value / a, i_map)
